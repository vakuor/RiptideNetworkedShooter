...
```
cd existing_repo
git remote add origin https://gitlab.com/vakuor/mobileshooterclient.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/vakuor/mobileshooterclient/-/settings/integrations)
